...
void Explosion::InitializeGraphicsPipeline()
{
	...
	result = D3DCompileFromFile(
		L"Resources/Shaders/Particle/Explosion/ExplosionVS.hlsl",	// シェーダファイル名
		nullptr,
...
// errorBlobからエラー内容をstring型にコピー
	...
	result = D3DCompileFromFile(
		L"Resources/Shaders/Particle/Explosion/ExplosionGS.hlsl",	// シェーダファイル名
		nullptr,
		D3D_COMPILE_STANDARD_FILE_INCLUDE, // インクルード可能にする
...
// errorBlobからエラー内容をstring型にコピー
	...
	// ピクセルシェーダの読み込みとコンパイル
	result = D3DCompileFromFile(
		L"Resources/Shaders/Particle/Explosion/ExplosionPS.hlsl",	// シェーダファイル名
		nullptr,
		D3D_COMPILE_STANDARD_FILE_INCLUDE, // インクルード可能にする
...
// errorBlobからエラー内容をstring型にコピー
	...
	// コンピュートシェーダーのコンパイル
	D3DCompileFromFile(
		L"Resources/Shaders/Particle/Explosion/ExplosionCS.hlsl",
...
void Explosion::CSUpdate(ID3D12GraphicsCommandList* commandList,const bool& isExp,const Vector4& Pos)
{

	ID3D12DescriptorHeap* ppHeaps[ ] = { m_cbvSrvUavHeap.Get() };
	commandList->SetDescriptorHeaps(_countof(ppHeaps),ppHeaps);
	shaderParameters.Shot = static_cast<uint32_t>(isExp);
