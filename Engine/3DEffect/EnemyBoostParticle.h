...
public: // サブクラス
	...
	struct ShaderParameters
	{
		...
		uint32_t Shot = 0;
		uint32_t pad = 0;
		MyStruct::EnemyBoostPos boostPos;
	};
...
public: // メンバ関数
	...
	/// コンピュートシェーダーアップデート
	/// </summary>
	void CSUpdate(ID3D12GraphicsCommandList* cmdList,const MyStruct::EnemyBoostPos& boostPos,const float& boostPower/*,const uint32_t& shot*/);
